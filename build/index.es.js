...
import { createElement, Fragment, createContext, isValidElement, useState as useState$1, useEffect as useEffect$1 } from 'react';
...
}, function (props) { return props.theme.textFontFamily; }, function (props) { return props.secondary && css(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["\n      color: ", ";\n      background: transparent;\n      border-color: ", ";\n    "], ["\n      color: ", ";\n      background: transparent;\n      border-color: ", ";\n    "])), function (props) { return props.theme.primaryColorLight; }, function (props) { return props.theme.primaryColorLight; }); }, function (props) {
    return props.success && css(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n        background: ", ";\n        border-color: ", ";\n      "], ["\n        background: ", ";\n        border-color: ", ";\n      "])), function (props) { return props.theme.successColor; }, function (props) { return props.theme.successColor; });
}, function (props) {
    return props.failure && css(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n      background: ", ";\n      border-color: ", ";\n    "], ["\n      background: ", ";\n      border-color: ", ";\n    "])), function (props) { return props.theme.errorColor; }, function (props) { return props.theme.errorColor; });
...
var LegalNotice = function (props) {
    ...
    return (createElement(Fragment, null, (isFirstAccept || newerVersionExists) && (createElement(Warning, { "data-test-id": "legal-notice" },
        createElement(Surface, null,
            createElement(GridContainer, { gap: 5 },
                createElement(GridItem, { xs: "3/7" },
                    isFirstAccept && (createElement(Fragment, null,
                        createElement(H4, null, "Cookie notice"),
                        createElement(P, { sm: true }, "By using ticketbuddy.co.uk, you consent to our cookie and terms and conditions policy."))),
                    !isFirstAccept && newerVersionExists && (createElement(Fragment, null,
                        createElement(H4, null, "Updated terms and conditions"),
                        createElement(P, { sm: true }, "Please review our latest terms and conditions and cookie policy.")))),
                createElement(GridItem, { xs: "7/10", horizontalAlign: "right", vertialAlign: "center" },
                    createElement(Button, { "data-test-id": "accept-legal-btn", sm: true, onClick: function () { return props.onAccept(); } }, "I agree"))))))));
};
...
var SignInForm = function (props) {
    ...
    return (createElement("form", { onSubmit: handleSubmit(onSubmit) },
        createElement(GridContainer, null,
            createElement(GridItem, { xs: "1/13", vertialAlign: "center" },
                createElement(GridContainer, { gap: 1 },
                    createElement(GridItem, { xs: "1/13", sm: "2/12", md: "4/10", lg: "5/8" },
                        createElement(H1, { "data-testid": "sign-in-title" }, "Sign In"),
                        errors.credentials && createElement(Error$1, { "data-testid": "credentials-error" }, "Invalid credentials, please try again.")),
                    createElement(GridItem, { xs: "1/13", sm: "2/12", md: "4/10", lg: "5/8" },
                        createElement(Input, { "data-testid": "email-input", error: !!errors.email, type: "email", placeholder: "Email", name: "email", ref: register({ required: true }) }),
                        errors.email && createElement(Error$1, { "data-testid": "email-error" }, "Email is required")),
                    createElement(GridItem, { xs: "1/13", sm: "2/12", md: "4/10", lg: "5/8" },
                        createElement(Input, { "data-testid": "password-input", error: !!errors.password, type: "password", placeholder: "Password", name: "password", ref: register({ required: true }) }),
                        errors.password && createElement(Error$1, { "data-testid": "password-error" }, "Password is required")),
                    createElement(GridItem, { xs: "1/13", sm: "2/12", md: "4/10", lg: "5/8", horizontalAlign: "center" },
                        createElement(Button, { "data-testid": "submit-sign-in" }, "Sign In")))))));
};

var Image = styled.div(templateObject_1$6 || (templateObject_1$6 = __makeTemplateObject(["\n  background-image: url(\"", "\");\n  height: ", ";\n  width: ", ";\n  /* Position and center the image to scale nicely on all screens */\n  background-position: center;\n  background-repeat: no-repeat;\n  background-size: cover;\n  position: relative;\n"], ["\n  background-image: url(\"", "\");\n  height: ", ";\n  width: ", ";\n  /* Position and center the image to scale nicely on all screens */\n  background-position: center;\n  background-repeat: no-repeat;\n  background-size: cover;\n  position: relative;\n"])), function (_a) {
    var src = _a.src;
    return src;
}, function (_a) {
...
var ImageContainer = styled.div(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["\n  position: relative;\n  overflow: hidden;\n"], ["\n  position: relative;\n  overflow: hidden;\n"])));
...
function useTbApi(request) {
    var _this = this;
    var _a = useState$1({ body: null, statusCode: null }), response = _a[0], setResponse = _a[1];
...
export { Button, EnumState, Error$1 as Error, GridContainer, GridItem, H1, H2, H3, H4, H5, Image, ImageContainer, Input, LegalNotice, P, PromoterCard, SignInForm, Surface, TextArea, useCreditor };
